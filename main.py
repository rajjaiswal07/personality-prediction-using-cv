...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
    ...
    print(personality)
    print(aplcnt_name.get())
    print(age)

    # op = Tk()
    # myLabel = Label(op, text = str('{} : {}'.format("Age:", age)))
    # myLabel.pack()
    # op.mainloop()
    ...
    #         print(str(key.title()))
            # print(str('{} : {}'.format(check_type(key.title()),check_type(data[key]))))
    ...
    # print("perdicted personality: "+personality)
